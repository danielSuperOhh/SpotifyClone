...
export const Home = ({ toggleNav }) => {
  ...
  const togglePlayPause = (songLink) => {
    if (isPlaying) {
        ...
        <SongWrapper>
          ...
          <Section3>
            <SectionBox>
              ...
              <ButtonSection>
                <TwoButtons>
                  <Button value={<TextLink>PLAY</TextLink>} />
                  <Button value={<TextLink>FOLLOW</TextLink>} />
                </TwoButtons>
                <ButtonSectionText>
          ...
          <Section5>
            ...
            {tracks?.items?.map((track, i) => (
              <Section55Header onClick={() => play(track)} key={track?.id}>
                <Class1>
                  <AshNum>{i + 1}</AshNum>
                  <SongTitle>
                    {track?.track?.name.split("").slice(0, 15)}
                ...
                <Class3>
                  ...
                  <SongAlbumm>
                    {track?.track?.album?.name.split("").slice(0, 15)}
                    {track?.track?.album?.length > 15 ? "..." : ""}
                  </SongAlbumm>
                </Class3>
              </Section55Header>
            ))}
          ...
          <MusicPlayer>
            <TopSide>
              ...
              <AlbumArt>
                ...
                <PlayUlt>
                  <button onClick={togglePlayPause}>
                    {isPlaying ? (
                      <BsPauseFill size="30px" color="#221C33" />
                    ) : (
                      <BsPlayFill size="30px" color="#221C33" />
                    )}
                  </button>
                </PlayUlt>
              </AlbumArt>
              ...
              <Play>
                ...
                <button onClick={togglePlayPause}>
                  {isPlaying ? (
                    <BsFillPauseCircleFill size="30px" color="#221C33" />
                  ) : (
                    <BsFillPlayCircleFill size="30px" color="#221C33" />
                  )}
                </button>
      ...
      <RightSide>
        ...
        <MusicCardCover>
          <MusicCard>
            <MusicCardBox>
              <SecondCard
                img={currentSong?.track?.album?.images[0]?.url}
              ></SecondCard>
              <CardArtist>
                <CardName>
                  <CName>{currentSong?.track?.name}</CName>
                  <CTag>
                    {currentSong?.track?.artists?.map(
                      (artist) =>
                        `${artist?.name}${
                          currentSong?.track?.artists?.length > 1 ? ", " : ""
                        }`
                    )}
                  </CTag>
                </CardName>
                <CardIcon>
                  <button onClick={toggleAddMusic}>
                    {isToggle ? (
                      ...
                      <MdOutlineAddCircleOutline size="20px" />
                    )}
                  </button>
                </CardIcon>
              </CardArtist>
